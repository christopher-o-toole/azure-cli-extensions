...
with open(os.path.join(extension_path, 'azext_thoth_experimental', 'version.py'), 'r') as version_file:
...
setup(
    name='thoth_experimental',
    version=VERSION,
    description='Recommend recovery options on failure. (Experimental)',
    ...
    package_data={'azext_thoth_experimental': ['azext_metadata.json']},
)